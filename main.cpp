...
int main() {
    ...
    std::shared_ptr<Room> south_of_house = std::make_shared<Room>("south-of-house",
                                    "You are facing the south side of a white house. There is no door here, and all the windows are barred. There is a pot of plant here.\n");
    ...
    start->setLocked(true); // Khóa cửa của start-room ban đầu
